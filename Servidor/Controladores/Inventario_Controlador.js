...
class Inventario_Controlador{
    ...
    agregar_producto(req, res){
        let{codigo, nombre, descripcion, cantidad, precio} = req.body
        const Model = new Inventario_Modelo(null, codigo, nombre, descripcion, cantidad,precio)
    ...
    consultar_producto(req,res){
        ...
        const Model = new Inventario_Modelo(id_inventario, null, null, null, null,null)
    ...
    consultar_productos(req,res){
        const Model = new Inventario_Modelo(null, null, null, null, null,null)
    ...
    modificar_producto(req, res){
        let {id_inventario, codigo, nombre, descripcion, cantidad, precio} = req.body
        const Model = new Inventario_Modelo(id_inventario, codigo, nombre, descripcion, cantidad, precio)
